<?php
session_start();
#connected to php file
require_once("mysql-init2.php");
$db_handle = new DBController();
if(!empty($_GET["action"])) {
#switch case
switch($_GET["action"]) {
#action can be add,remove or empty
        #case 1
	case "add":
...
<!-- no bootstrap add here chutiya !-->
<link href="style.css" type="text/css" rel="stylesheet" />
</HEAD>
<BODY>
<div id="shopping-cart">
<!-- check karo table, then add the requirement design !-->
